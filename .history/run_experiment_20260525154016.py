...
def main():
    ...
    parser.add_argument('--clamp-mode', choices=['set_I_R', 'add_clamp_gain', 'overwrite_fired'],
                        default='set_I_R')
    parser.add_argument('--cls-force-spike-every', type=int, default=1)
    parser.add_argument(
