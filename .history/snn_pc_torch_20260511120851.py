"""Torch-backed SNN-PC implementation with GPU-capable state and weights.

The model, state evolution, and learning rule run in torch. Numpy is kept at
the outer edge for plotting, sklearn decoding, and legacy compatibility.
"""
